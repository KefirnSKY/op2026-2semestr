...
PROCEDURE Bump; {Увеличивает счетчик}
PROCEDURE Value (VAR V100, V10, V1: CHAR); {Возвращает содержимое счетчика}
IMPLEMENTATION
 VAR
  Ones, Tens, Hundreds: CHAR; {Цифры счетчика: единици, десятки, сотни}
  PROCEDURE Start; {Сбрасывает счетчик в 0}
  BEGIN{Start}
    Ones := '0';
    Tens := '0';
  ...
  PROCEDURE NextDigit(VAR Digit: CHAR); {Сдвигает счетчик на единицу}
  BEGIN {NextDigit}
